...
export function renderTable(container, displayColumns, rows, specialCols, tableId, onCellSaved) {
  container.innerHTML = "";
...
// its own row cache in sync without this module knowing about it.
